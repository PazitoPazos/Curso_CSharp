namespace Clases_selladas
{
    ...
    class Adolescente(string nombre) : Humano(nombre)
    {
    ...
    sealed class Gorila(string nombre) : Mamifero(nombre), IMamiferosTerrestres
    {
    ...
    class Chimpance(string nombre) : Gorila(nombre)
    {
